...
function DataService ($http, $q) {
  ...
  this.getTodos = function(cb) {
    $http.get('/projects-api/todo/api/todos').then(cb);
  };
  ...
  this.deleteTodo = function(todo) {
    ...
    return $http.delete('/projects-api/todo/api/todos/' + todo._id).then(function() {
  ...
  this.saveTodos = function(todos) {
    ...
    todos.forEach(function(todo) {
      var request;
      if(!todo._id) {
        request = $http.post('/projects-api/todo/api/todos', todo);
      } else {
        request = $http.put('/projects-api/todo/api/todos/' + todo._id, todo).then(function(result) {
